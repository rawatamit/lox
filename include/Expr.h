...
public:
  ...
  visitAssign(std::shared_ptr<Assign> Expr) = 0;
  virtual std::shared_ptr<LoxObject>
  visitBinaryExpr(std::shared_ptr<BinaryExpr> Expr) = 0;
  ...
  virtual std::shared_ptr<LoxObject>
  visitGroupingExpr(std::shared_ptr<GroupingExpr> Expr) = 0;
  virtual std::shared_ptr<LoxObject>
  visitLiteralExpr(std::shared_ptr<LiteralExpr> Expr) = 0;
  virtual std::shared_ptr<LoxObject>
  visitLogical(std::shared_ptr<Logical> Expr) = 0;
  ...
  virtual std::shared_ptr<LoxObject>
  visitSuper(std::shared_ptr<Super> Expr) = 0;
  virtual std::shared_ptr<LoxObject>
  visitUnaryExpr(std::shared_ptr<UnaryExpr> Expr) = 0;
  virtual std::shared_ptr<LoxObject>
  visitVariable(std::shared_ptr<Variable> Expr) = 0;
};
...
class BinaryExpr : public std::enable_shared_from_this<BinaryExpr>,
                   public Expr {
public:
...
class GroupingExpr : public std::enable_shared_from_this<GroupingExpr>,
                     public Expr {
public:
...
class LiteralExpr : public std::enable_shared_from_this<LiteralExpr>,
                    public Expr {
public:
  LiteralExpr(TokenType type, std::string value) : type(type), value(value) {}
  std::shared_ptr<LoxObject> accept(ExprVisitor &visitor) override {
