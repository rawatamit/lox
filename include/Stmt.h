...
public:
  virtual ~StmtVisitor() {}
  virtual std::shared_ptr<LoxObject>     visitBlock      (std::shared_ptr<Block      > Stmt) = 0;
  virtual std::shared_ptr<LoxObject>     visitClass      (std::shared_ptr<Class      > Stmt) = 0;
  virtual std::shared_ptr<LoxObject>     visitExpression (std::shared_ptr<Expression > Stmt) = 0;
  virtual std::shared_ptr<LoxObject>     visitFunction   (std::shared_ptr<Function   > Stmt) = 0;
  virtual std::shared_ptr<LoxObject>     visitIf         (std::shared_ptr<If         > Stmt) = 0;
  virtual std::shared_ptr<LoxObject>     visitPrint      (std::shared_ptr<Print      > Stmt) = 0;
  virtual std::shared_ptr<LoxObject>     visitReturn     (std::shared_ptr<Return     > Stmt) = 0;
  virtual std::shared_ptr<LoxObject>     visitWhile      (std::shared_ptr<While      > Stmt) = 0;
